...
<html>
<head>
	<title>GREEK GUIDE - Word Count per App</title>
...
$(document).ready(function() {
				...
				if( i != 5 && i != 6)
				{
					var select = $('<select><option value=""></option></select>')
						...
						.on( 'change', function () {
							...
							$("#GGresults").find("tfoot tr:nth-child(1) th:nth-child(11)").text( table.column(11, {page:'current'}).data().sum() ); 
							$("#GGresults").find("tfoot tr:nth-child(1) th:nth-child(12)").text( table.column(12, {page:'current'}).data().sum() ); 
	...
	$("#GGresults").find("tfoot tr:nth-child(1) th:nth-child(11)").text( table.column(11).data().sum() );
	$("#GGresults").find("tfoot tr:nth-child(1) th:nth-child(12)").text( table.column(12).data().sum() );
...
<%
	...
	Session("xAppID") = AppID
	
	'Retrieve all records.
	cmdStoredProc.CommandText = "usp_Word_Count_Per_App"
...
<div id="selectedAppHdn" style="display:none;"><%= CInt(Session("xAppID")) %></div>
